  ...
  if (questions.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center p-8 bg-slate-900 border border-slate-800 rounded-3xl max-w-md mx-auto text-center">
        <HelpCircle className="w-12 h-12 text-slate-400 animate-pulse mb-4" aria-hidden="true" />
    ...
    <div className="relative w-full max-w-2xl mx-auto rounded-3xl bg-slate-950 border border-slate-800 shadow-2xl p-6 md:p-8 overflow-hidden">
        ...
        <AnimatePresence custom={direction} mode="wait">
          ...
          >
            <fieldset className="border-0 p-0 m-0 flex flex-col">
              <legend className="text-xl md:text-2xl font-black text-white leading-snug tracking-tight mb-6">
                ...
                {currentQuestion.options.map(option => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex items-center justify-between p-4 rounded-2xl border text-left transition-all duration-205 group focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none ${
                        selected
      ...
      <div className="relative z-10 flex justify-between items-center mt-8 pt-6 border-t border-slate-900">
        <button
          ...
          className="flex items-center gap-1.5 text-slate-400 hover:text-white font-bold text-sm disabled:opacity-30 disabled:pointer-events-none transition-all py-2 focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none rounded"
        >
        ...
        <button
          ...
          className="flex items-center gap-1.5 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 disabled:opacity-40 disabled:pointer-events-none text-white font-bold px-6 py-3 rounded-full text-sm transition-all duration-300 shadow-lg shadow-indigo-950/30 hover:scale-[1.02] focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none"
        >
